...
function ShowFlag(sMsg) {
    if (sMsg.indexOf('登录成功！欢迎回来') != -1) {

        if (typeof LuckyDrawer != 'undefined') {
            LuckyDrawer.LoginCallBack();
        }
    }
};
ENetwork.DownloadScript('http://luckydraw.edushi.com/LuckyDraw.ashx');
