...
function fnShowByPage(iPage)
{
    ...
    switch (_SearchType) {
        case '1':       
            sSearchUrl = 'http://aip.fangtoo.com/house.aspx?type=jsonbuildinglist&citydomain=hangzhou&page=' + _Page + '&pagesize=' + _PageSize + '&k=' + escape(_Key);
            break;
        case '2':
            sSearchUrl = 'http://aip.fangtoo.com/NewHouseList.aspx?citydomain=hangzhou&page=' + _Page + '&pagesize=' + _PageSize + '&regionCode=' + _RegionCode + '&housekind=' + _HouseKind + '&pl=' + _PL + '&ph=' + _PH + '&k=' + escape(_Key);
            break;
        case '3':
            sSearchUrl = 'http://aip.fangtoo.com/TradeHouseList.aspx?citydomain=hangzhou&page=' + _Page + '&pagesize=' + _PageSize + '&regionCode=' + _RegionCode + '&room=' + _HouseKind + '&pl=' + _PL + '&ph=' + _PH + '&k=' + escape(_Key);
            break;
            case '4':
                sSearchUrl = 'http://aip.fangtoo.com/LeaseHouseList.aspx?citydomain=hangzhou&page=' + _Page + '&pagesize=' + _PageSize + '&regionCode=' + _RegionCode + '&room=' + _HouseKind + '&pl=' + _PL + '&ph=' + _PH + '&k=' + escape(_Key);
                break;
            case '5':
                sSearchUrl = 'http://aip.fangtoo.com/BuildingList.aspx?citydomain=hangzhou&page=' + _Page + '&pagesize=' + _PageSize + '&k=' + escape(_Key);
            break;
    }
    if (sSearchUrl != '') {
