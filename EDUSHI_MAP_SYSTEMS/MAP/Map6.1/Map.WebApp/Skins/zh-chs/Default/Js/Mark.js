...
function Mark()
{
    ...
    this.AddHTML = '<div class="TagNav"><div class="PinIco" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/Images/PinIco.png\',sizingMethod=\'image\') !important;"></div><div class="InTagCon"><div class="InTagConBg" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/Images/InTagBg.png\',sizingMethod=\'image\') !important;"></div><div class="InTagDetCon"><h3>标记</h3><table cellpadding="1" cellspacing="0" border="0"><tr><th>标题：</th><td><input id="txtMarkTitle" style="width:228px; border:solid 1px #666" value="" type="text" /></td></tr><tr><th></th><td class="Explain">(<span>※</span>此项为必填项 控制在20字符以内)</td></tr><tr><th>内容：</th><td><textarea id="txtMarkContent" style=" border:solid 1px #666" cols="26"  rows="4"></textarea></td></tr><tr><td colspan="2" align="center"><img id="btnMarkConfirm" src="/Images/TagBtn.gif" style="cursor:pointer" alt="确认" /></td></tr></table></div><div id="btnMarkClose" class="CloseWin" onmouseover="this.className=\'CloseBtnOver\'" onmouseout="this.className=\'CloseBtnOut\'" title="关闭"></div></div></div>';
    
    this.ShowHTML = '<div class="TagNav"><div class="PinIco" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/Images/PinIco.png\',sizingMethod=\'image\') !important;"></div><div class="ViewTagConMax"><div class="ViewTagConBg" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/Images/ViewTagBg.png\',sizingMethod=\'image\')!important;"></div><div class="ViewTagDetCon"><h3 id="MarkTitle"></h3><div class="AutoText" id="MarkContent"></div><div class="WkButton"><img id="btnMarkDelete" style="cursor:pointer" src="/Images/DeleteTag.gif" alt="删除标记" />&nbsp;&nbsp;<img id="btnMarkCopy" style="cursor:pointer" src="/Images/ToFriend.gif" alt="复制给好友" /></div></div><div id="MarkMaxMin" class="SwNavOut" onmouseover="this.className=\'SwNavOver\'" onmouseout="this.className=\'SwNavOut\'" title="收缩/展开"></div></div></div>';
