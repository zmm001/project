...
function fnOnload()
{
    ...
    ENetwork.DownloadScript(sFilterUrl,function(){
        if(typeof ShopType !='undefined' && ShopType.TradeProperty.length >0)
        {
            ...
            sFilterHtml += '<input type="image" onclick="doFilter()" src="../images/SrFilBtn.gif" alt="确定" />'; 
            ...
            if(BusinessInfo.Topic.length > 0)
            {
                ...
                for(var i=0; i<iRowCount; i++)
                {
                    ...
                    {                                
                        ...
                        sHtml += '<li><a target="_blank" href="'+window.Config.DianUrl+'VipStore/'+oTopic.LST_ID+'/EShopNewsView.aspx?StoreID='+oTopic.MCI_ID+'&newsid=' + oTopic.LT_ID + '">'+oTopic.LT_Title.substr(0,16)+'</a><img src="../images/Cu.gif" alt="本店正在促销打折" /></li>';
                    }
                    sHtml += '</ul>';
                }
            ...
            if(BusinessInfo.Voucher.length > 0)
            {
                ...
                for(var i=0; i<iRowCount; i++)
                {
                    ...
                    {                                
                        ...
                        sHtml += '<li><a target="_blank" href="'+window.Config.DianUrl+'VipStore/'+oVoucher.LST_ID+'/VoucherView.aspx?id='+oVoucher.LV_ID+'&StoreID=' + oVoucher.MCI_ID +'">'+oTopic.LT_Title.substr(0,16)+'</a><img src="../images/Juan.gif" alt="免费下载本店优惠券" /></li>';
                    }
                    sHtml += '</ul>';
                }
