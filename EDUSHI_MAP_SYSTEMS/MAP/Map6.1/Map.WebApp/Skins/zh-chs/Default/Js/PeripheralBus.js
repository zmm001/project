...
{       
    var sHtml = '<div id="TabContent" class="periheralBus">这里是<strong>'+unescape(fnRequest('oname'))+'</strong>的周边公交：<br />点击您需要的公交站查看吧！点击"<img src="/Images/GoToIco.gif" alt="定位公交站点" />"可在地图上定位';
