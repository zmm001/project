...
function fnShowData() {
    ...
    if (_Search.length > 0) {
        ...
        if (_SearchType == 3) {
            ...
            $('TabContent').innerHTML = '<div class="JG_w"><div class="title">抱歉，在' + window.Config.CityName + '范围内没有找到与<span>“' + _Key + '”</span>有关的相关结果！</div><ul class="JG_ul"><li>1、看看输入的关键词否有误。</li><li>2、重新输入其它关键词试试。</li></ul></div>';
        }
        fnResize();
        return;
    }
