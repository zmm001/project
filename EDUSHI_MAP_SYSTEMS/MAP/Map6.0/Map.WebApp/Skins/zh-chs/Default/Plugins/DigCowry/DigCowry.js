...
Object.extend(DigCowry.prototype, {
    ...
    Init: function() {
        ...
        $('MapToolBar').innerHTML = $('MapToolBar').innerHTML + '<li><a href="javascript:fnBeginDig()" title="挖宝"><img id="liDigCowry" src="/DigCowry/Images/DigUpCowry.gif" alt="挖宝" /></a></li>';
        ...
        vM.attachEvent(EGIS.KeyWord.EventName.MapClick, function(e) {
            if (_DcIsBeginDigCowry) {
                fnStopDig();
                var div = vM.$C('div');
                div.innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="190" height="180"><param name="movie" value="/DigCowry/images/spade.swf" /><embed src="/DigCowry/images/spade.swf" quality="high" wmode="transparent" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="190" height="180"></embed><param name="wmode" value="transparent"></param></object>';
                var x = vM.PointerX();
                var y = vM.PointerY();
