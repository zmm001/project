    ...
    LoadPopData: function() {
        if (typeof _EntityInfo != 'undefined' && _EntityInfo.CompanyInfoDetail[0]) {
            ...
            if (o.CustomDomain > 0) {
                ...
                if (o.Vip * 1 > 0) {
                    this.$('Img_a').href = 'http://' + o.Eaddress + '.' + window.Config.Domain;
                }
                else {
                    this.$('Img_a').href = 'http://' + this.Config.Domain + '/yp/CompanyDetail.aspx?id=' + o.BCC_CompanyID;
                }
            }
            this.$('Img_a').href = 'http://' + this.Config.Domain + '/yp/CompanyDetail.aspx?id=' + o.BCC_CompanyID;
            ...
            if (o.CustomDomain > 0) {
                ...
                if (o.Vip * 1 > 0) {
                    this.$('view_a').href = 'http://' + o.Eaddress + '.' + window.Config.Domain;
                }
                else {
