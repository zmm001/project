...
function EAddress()
{
    ...
    this.AddHTML = '<div class="TagNav"><div class="PinIco" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/Images/PinIco.png\',sizingMethod=\'image\') !important;"></div><div class="InTagCon"><div class="InTagConBg" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'/Images/InTagBg2.png\',sizingMethod=\'image\') !important;"></div><div class="InTagDetCon"><h3>我的E地址</h3><table cellpadding="1" cellspacing="0" border="0"><tr><th>标题：</th><td><input id="txtEAddressTitle" style="width:228px; border:solid 1px #666" value="" type="text" /></td></tr><tr><th></th><td class="Explain">(<span>※</span>此项为必填项 控制在20字符以内)</td></tr><tr><th>内容：</th><td><textarea id="txtEAddressContent" style=" border:solid 1px #666" cols="26"  rows="4"></textarea></td></tr><tr><td colspan="2" align="center"><img id="btnEAddressConfirm" src="/Images/TagBtn.gif" style="cursor:pointer" alt="确认" />&nbsp;&nbsp;<img id="btnEAddressReBegin" src="/Images/ReMapAc.gif" style="cursor:pointer" alt="重新取点" /></td></tr></table></div><div id="btnEAddressClose" class="CloseWin" onmouseover="this.className=\'CloseBtnOver\'" onmouseout="this.className=\'CloseBtnOut\'" title="关闭"></div></div></div>';
