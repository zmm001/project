...
//        if (this.OID != 0) {
//            //setTimeout(function() { this.$("ad_iframe").contentWindow.location.reload(); }, 200);
//            //this.$("adiframe").contentWindow.document.frames[0].href = this.$("adiframe").contentWindow.document.frames[0].href;
//            //alert();
