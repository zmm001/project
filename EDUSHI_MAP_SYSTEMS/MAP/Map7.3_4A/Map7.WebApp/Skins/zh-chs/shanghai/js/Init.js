...
window.onresize = function() {
    ...
    if (_MapFullScreenState) {
        ...
        if (window.XMLHttpRequest) {
            ...
            $('maploading').style.top = (h - 160) / 2 + 'px';
            $('maploading').style.left = (w - 400) / 2 + 'px';
        } else {
...
function fnSwichCity() {
    ...
    if (citylistifrmae) {
        ...
        citylistifrmae.style.height = '458px';
...
function fnCheckUserLoginInit() {
    if ($('liLoginInfo').innerHTML == '') {
        ...
        if (cookieNickNameCookie != null) {
            ...
            $('liLoginInfo').innerHTML = '<span>欢迎您！</span><a href="' + GlobalConfig.UserCenterUrl + 'Register.aspx" target="_blank" title="注册">[注册]</a><a href="javascript:;" onclick="top.location.href=\'http://my.edushi.com/Login.aspx?BackUrl=\'+encodeURIComponent(window.location.href);">[登录]</a>';
        }
    }
}
...
function fnLoginOutSuccess() {
    $('liLoginInfo').innerHTML = '<span>欢迎您！</span><a href="' + GlobalConfig.UserCenterUrl + 'Register.aspx" target="_blank">[注册]</a><a href="javascript:;" onclick="top.location.href=\'http://my.edushi.com/Login.aspx?BackUrl=\'+encodeURIComponent(window.location.href);">[登录]</a>';
}
/*×××××××××××××××××用户登录部分×××××××××××××××××*/
...
function fnShowScaleResult(_dis, id) {
    ...
    if (AlaMap.Browser.msie) {
        vM.$(id).innerHTML = '总长：' + _dis + '<div title="关闭" style="cursor:pointer; position: absolute; right:-21px;top:-1px; height: 20px; width: 20px;overflow: hidden;float:right;border:solid 1px #b7cf2f;padding:1px; color:#849815; text-align:center;"><img onclick="parent.CloseScaleFlag();" style="height: 16px; width: 16px;" src="Images/share_close.jpg" /></div>';
    }
    else {
        vM.$(id).innerHTML = '总长：' + _dis + '<div title="关闭" style="cursor:pointer; position: absolute; right:-17px;top:-1px; height: 14px; width: 14px;overflow: hidden;float:right;border:solid 1px #b7cf2f; color:#849815; text-align:center;"><img onclick="parent.CloseScaleFlag();" style="height: 14px; width: 14px;" src="Images/share_close.jpg" /></div>';
    }
