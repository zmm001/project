...
window.onresize = function() {
    ...
    if (_MapFullScreenState) {
        ...
        $('Content').style.height = (h - 69) + 'px';

        $('EdushiMap').style.width = w + 'px';
        $('EdushiMap').style.height = (h - 69) + 'px';

        $('Wrapper').style.height = (h-43) + 'px';
        ...
        if (window.XMLHttpRequest) {
            $('Content').style.height = (h - 150) + 'px';
            $('Content').style.width = (w - 326) + 'px';
            $('EdushiMap').style.width = (w - 324) + 'px';
            $('EdushiMap').style.height = (h - 152) + 'px';
            $('maploading').style.top = (h - 200) / 2 + 'px';
            $('maploading').style.left = (w - 400) / 2 + 'px';
        } else {
            $('Content').style.height = (h - 154) + 'px';
            $('Content').style.width = (w - 328) + 'px';
            $('EdushiMap').style.width = (w - 326) + 'px';
            $('EdushiMap').style.height = (h - 188) + 'px';
            $('maploading').style.top = (h - 200) / 2 + 'px';
            $('maploading').style.left = (w - 400) / 2 + 'px';
        }

        $('ulChannellList').style.width = (w - 312) + 'px';
        $('MapHotKeywords').style.width = (w - 752) + 'px';
        $('divBdtList').style.width = (w - 600) + 'px';
        $('toolsleft').style.width = (w - 324) + 'px';
        $('Wrapper').style.height = (h - 124) + 'px';
        $('BodyContainer').style.height = (h - 159) + 'px';
        $('Navigation').style.height = (h - 124) + 'px';

        if ((w - 324) < 660) {
            $('ulThemeList1').style.display = 'none';
        }
        else {
            $('ulThemeList1').style.display = '';
        }

        if ((w - 324) < 550) {
            $('divtool').style.display = 'none';
        } else {
            $('divtool').style.display = '';
        }
