...
Object.extend(WaterBusStationControl.prototype, {
    ...
    ShowBusStation: function(id, sStationName, x, y) {
        ...
        var tempUrl = 'http://' + this.Config.Domain + '/?sid=' + id + '&x=' + x + '&y=' + y + '&sname=' + escape(sStationName) + '&type=water';
        ...
        ENetwork.DownloadScript(url, function() {
            ...
            if (typeof _BusLineList == 'undefined' || _BusLineList.length < 1) {
                ...
                for (var k = 0; k < _BusLineList.length; k++) {
                    ...
                    sHtml += string.Format('<li><dl><dt><a href="javascript:;" onclick="window.WaterBusStationControl.onBusClick({1},\'{2}\',\'{3}\')">{0}</a><span>（班次信息）</span></dt><dd><a href="javascript:;">{4}</a></dd></dl></li>', _BusLineList[k].VehicleName, _BusLineList[k].VehicleID, _BusLineList[k].VehicleName, sStationName, _BusLineList[k].VehicleFrequency);
                }
