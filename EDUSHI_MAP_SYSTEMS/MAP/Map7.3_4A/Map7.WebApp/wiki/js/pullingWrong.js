...
function fnCheckUserLoginInit(edatacenterUrl,cityCode) {
    ...
    if ($('liLoginInfo').innerHTML == '') {
        ...
        if (cookieNickNameCookie != null) {
            ...
            $('liLoginInfo').innerHTML = '欢迎您！<span style="color:#ff6400">' + unescape(cookieNickNameCookie) + '</span><span>[<a href="' + pwedatacenterurl + 'Index.aspx?city=' + pwcityCode + '" target="_blank">我的E都市</a>]</span>&nbsp;<span>[<a href="javascript:fnLoginOut();">退出</a>]</span>';
        }
        else {            
