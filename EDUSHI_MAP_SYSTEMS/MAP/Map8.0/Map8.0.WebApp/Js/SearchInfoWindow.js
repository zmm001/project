...
(function () {
    ...
    */
    ...
    baidu.object.extend(SearchInfoWindow.prototype, {
        ...
        */
        _bind: function () {
            ...
            baidu.on(this.dom.busBtn, "click", function (e) {
                me._transitRouteAction(me.transitRoute,'bus');
            });
            ...
            baidu.on(this.dom.driveBtn, "click", function (e) {
                me._transitRouteAction(me.drivingRoute,'drive');
            });
        ...
        * 公交驾车检索查询
        */
        _transitRouteAction: function (transitDrive,type) {
            ...
            if (kw == "") {
                ...
                var transPoi1 = this._getTransPoi1(kw);
                if(type=='bus')
                {
                    parent.fnAddBusTransferSearchTab(transPoi1.start,transPoi1.end,'');
                }
                else if(type=="drive")
                {
                    parent.fnAddDriveTransferSearchTab(transPoi1.start,transPoi1.end,'');
                }
            }
        },
