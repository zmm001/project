...
//            this.Body.contentWindow.document.getElementsByTagName('head')[0].appendChild(_script);
    ...
    BtnRangSearch: function (key, x, y, oName) {
        switch (key) {
            case 'hotel':
                parent.rangeSearch(x, y, '酒店|宾馆', oName, 'company', this.OID);
                break;
            case 'food':
                parent.rangeSearch(x, y, '美食', oName, 'company', this.OID);
                break;
            case 'feature':
                parent.rangeSearch(x, y, '景点', oName, 'company', this.OID);
                break;
//            case 'bank':
//                parent.rangeSearch(x, y, '银行|ATM', oName, 'company', this.OID);
//                break;
//            case 'edian':
//                parent.rangeDianSearch(x, y, '店铺', oName, 'company', this.OID);
//                break;
            case 'other':
