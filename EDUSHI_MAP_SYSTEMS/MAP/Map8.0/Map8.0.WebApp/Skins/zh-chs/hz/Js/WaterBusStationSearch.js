    ...
    this.fnBusStationShow = function(kw) {
        if (typeof _Station != 'undefined' && _Station.length > 0) {
            ...
            for (i = 0; i < l; i++) {
                ...
                s += string.Format('<div class="gj_a1 gj_a2"><div class="title clearfix" onclick = "javaccript:fnShowLi({0},{1},{2},\'{3}\',{4});"><div class="number2" id="number{12}">+</div><div class="T_left">{5}</div></div><div class="xxl_all" style="display: none;" id="stationdiv{6}"><div class="xlxx"><div class="time_bus clearfix"><div class="title_S">位 置</div><div class="text_S">{7}</div></div><div class="time_bus clearfix"><div class="title_S">周边小区</div><div class="text_S">{8}</div></div><div class="time_bus clearfix"><div class="title_S">公交车站分布</div><div class="text_S">{9}</div></div><div class="time_bus clearfix"><div class="title_S">慢行系统分布</div><div class="text_S">{10}</div></div></div><div class="xl"><div class="title_xl title_xl2 ">经过线路</div><ul class="ul_xl2 clearfix">{11}</ul></div></div></div>', i, _tStation.PositionX, _tStation.PositionY, _tStation.StationName, _tStation.StationID, _tStation.StationName, i, _tStation.Place, _rangCom, _rangBus, _tStation.SlowSystem, ss, i);
            }
