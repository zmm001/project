...
function reLoadPageSize() {
    var _height = parseInt(fnGetWindowHeight() - 144);
    if (_height > -1) {
        if ($('divstartul')) {
...
function fnResize(h) {
    if (!h) {
        if ($('drive_radio_bd').style.display == 'none') {
            $('TabContent').style.height = (fnGetWindowHeight() - 0) + 'px';
        }
        else {
            $('TabContent').style.height = (fnGetWindowHeight() - 65) + 'px';
        }
    }
    else {
        if ($('drive_radio_bd').style.display == 'none') {
            $('TabContent').style.height = (h - 0) + 'px';
        }
        else {
            $('TabContent').style.height = (h - 65) + 'px';
        }
    }
...
function fnOnload() {
    ...
    if (parseInt(fnGetWindowHeight() - 0) > 0) {
        $('TabContent').style.height = fnGetWindowHeight() - 0 + 'px';
    }
