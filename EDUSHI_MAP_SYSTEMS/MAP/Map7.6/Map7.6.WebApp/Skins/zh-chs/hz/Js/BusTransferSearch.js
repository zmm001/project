...
function fnShowTransferResult(result, index, s, e) {
    ...
    end += "			<li class=\"bus_way1_down\"><span style=\"height:16px;display:block;float:left;\"><img src=\"../images/pcde_170.png\"  style=\"display:none;\" /></span><a style=\"height:16px;float:left;cursor:pointer;\" onclick=\"parent.ShowSendHtml(_phonedata[" + (index - 1) + "]);\"><b>免费发送到手机</b></a>>> 全程" + result.TransferLength / 1000 + "公里</li>";
