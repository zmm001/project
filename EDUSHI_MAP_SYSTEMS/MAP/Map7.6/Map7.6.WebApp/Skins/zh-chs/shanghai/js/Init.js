    ...
    if (id > 0) {
        if (!_EntityPopControl) {
            ENetwork.DownloadScript('/Controls/EntityPopControl.js', function () {
                ...
                //兼容地图定位
                if (x == 0 && y == 0) {
                    _EntityPopControl.ID = vM.AppendEntity(_EntityPopControl.Body, _PopLayer, false, 0, 0, 485, 310, 92, 213, false);
                } else {
                    _EntityPopControl.ID = vM.AppendEntity(_EntityPopControl.Body, _PopLayer, false, x, y, 485, 310, 92, 213, false);
                }
...
function fnShowSubWayPop(index) {
    ...
    if (!_SubWayControl) {
        ENetwork.DownloadScript('/Controls/SubWayControl.js', function () {
            ...
            _SubWayControl.ID = vM.AppendEntity(_SubWayControl.Body, _PopLayer, false, x, y, 320, 230, 0, 0, false);
            _SubWayControl.Width = 320;
            _SubWayControl.Height = 230;
