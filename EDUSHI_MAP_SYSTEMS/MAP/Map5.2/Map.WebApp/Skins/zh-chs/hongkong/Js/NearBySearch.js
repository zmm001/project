...
function fnOnload()
{
    ...
    var sEntrPopASearch = '<div><strong>'+unescape(fnRequest('oname'))+'</strong>查找周边：</div><div id="NearBySeaNav"><div class="P">查找范围<input name="rdArea" id="minArea" value="500" onclick="ChangeArea(this)" checked="checked" type="radio" />500米&nbsp;&nbsp;<input name="rdArea" id="maxArea" onclick="ChangeArea(this)" value="1000" type="radio" />1000米 </div>'
