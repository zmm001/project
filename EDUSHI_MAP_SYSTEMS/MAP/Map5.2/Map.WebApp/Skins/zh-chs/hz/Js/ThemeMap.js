...
function fnShow(){
    ...
    var sLocalSearch = '<table width="100%" id="tbCommend" border="0" align="center" cellpadding="1" cellspacing="1"><!--_Tr--><tr><td style="width:15px">'
                            ...
                            + '<div class="ThemeMapCopy"><input value="{$ActiveThemeUrl}" type="text" onfocus="this.select()" /><div><img style="cursor:pointer;" src="' + window.Config.SkinPath + 'Images/ToFriend.gif" title="复制给好友" onclick="parent.fnCopyToClipboard(\'{$ActiveThemeUrl}\',\'复制好了，发给我的QQ/MSN好友分享吧！\');"></div></div>';
