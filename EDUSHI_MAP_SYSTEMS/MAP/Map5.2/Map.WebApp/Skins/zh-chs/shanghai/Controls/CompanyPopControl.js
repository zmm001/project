...
Object.extend(CompanyPopControl.prototype, {
    ...
    LoadPopData: function() {
       ...
       LoadHotelXML:function(){
                  ...
                  this.$('view_a').href='http://'+this.Config.Domain+'/yp/HotelCompany.aspx?id='+this.EntityInfo.CompanyID+'&SiteID='+ExistHotel.HotelID+'&SiteCode='+ExistHotel.SiteCode+'&CityCode='+this.Config.CityCode+'';
                }
                else 
                {
                 this.$('HotelXML').innerHTML="查看详情>>";
