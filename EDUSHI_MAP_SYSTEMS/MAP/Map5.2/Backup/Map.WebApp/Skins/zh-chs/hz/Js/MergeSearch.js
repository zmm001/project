    ...
    ENetwork.DownloadScript(sUrl, function() {
        ...
        if (typeof _SalesData != 'undefined') {
            if (_BdtData.length < 1) {
                iNumber++;
                HtmlArray.push('<li style="height:auto;"><div class="Number"><span>' + iNumber + '</span></div><div class="DetailCon"><div class="TitleNav"><a href="' + window.Config.BdtUrl + '" target="_blank" title="关于' + _Key + '的包打听">关于' + _Key + '的包打听</a></div><div class="Explain">有问题就去包打听，有问有答本地人</div><div class="Eaddress">' + window.Config.BdtUrl + '</div></div><div class="DottedLine"></div></li>');
            }
            //VoucherData 
            ...
            for (var i = 0; i < _BdtData.length; i++) {
                linkUrl = window.Config.BdtUrl+'ListedQu.aspx?ID=' + _BdtData[i].ID;
