...
function fnLoginOutSuccess(city) {
   document.getElementById("UserInfo").innerHTML = '欢迎您！&nbsp;<span>[<a href="http://my.edushi.com/Register.aspx" target="_blank">注册</a>]</span>&nbsp;<span>[<a href="http://my.edushi.com/Login.aspx?City='+city+'" target="_blank">登录</a>]</span>';
