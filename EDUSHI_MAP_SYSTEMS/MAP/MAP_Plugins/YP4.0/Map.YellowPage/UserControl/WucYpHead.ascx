...
<script type="text/javascript" language="javascript" >
 function getLoginState ()
 {
        ...
        if (cookieNickNameCookie != null) {
            obj.innerHTML = '欢迎您！<span style="color:#ff6400">' + cookieNickNameCookie + '</span><span>[<a href="<%=this.UserCenterUrl %>Index.aspx?city=<%=CityCode %>" target="_blank">我的E都市</a>]</span><span>[<a style="cursor:pointer;" onclick="fnLoginOut(\'<%=CityCode %>\');">退出</a>]</span><a href="javascript:;" onclick="this.style.behavior=\'url(#default#homepage)\';this.setHomePage(window.location.href);return(false);" title="设为首页">设为首页</a> | <a href="javascript:;" onclick="window.external.addFavorite(window.location.href,document.title)" title="加入收藏">加入收藏</a>';
        }
        else {
