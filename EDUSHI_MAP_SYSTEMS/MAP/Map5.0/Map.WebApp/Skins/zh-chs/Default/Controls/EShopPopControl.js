...
Object.extend(EShopPopControl.prototype,{
    ...
    LoadPopData : function(){
        if(typeof _EntityInfo != 'undefined' && _EntityInfo.CompanyInfoDetail[0])
        {
            ...
            this.$('Name_h3').innerHTML = o.OCName +'<img src="../Images/Edian.gif" alt="E店" />';
            ...
            this.$('view_a').href = this.Config.BendiUrl + 'vipstore/'+o.LST_ID+'/Index.aspx?StoreID='+ o.CompanyID +'&City='+this.Config.CityCode;
