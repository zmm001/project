...
Object.extend(TabControl.prototype,{
    ...
    changeSubPage:function(){
        if(this.TabList.length==0){
            ...
            for(var i=0;i<this.TabList.length;i++){
                myWidth += this.TabList[i].TabTitleWidth+5;//5像素偏移
            }
...
Object.extend(TabControl.Tab.prototype,{
    ...
    resize:function(){
        if(this.TabBody.contentWindow.document.getElementById('TabContent') != null){
            this.TabBody.contentWindow.document.getElementById('TabContent').style.height = this.TabBody.parentNode.clientHeight-63 + 'px';
        }        
    },
    active:function(){
