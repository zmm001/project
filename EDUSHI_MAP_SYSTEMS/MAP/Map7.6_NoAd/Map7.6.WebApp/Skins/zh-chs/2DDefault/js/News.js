...
//    }
//    else {
//        var url = window.Config.DataCetnerAdDataUrl + 'ad2.0/ads.aspx?citycode=' + window.Config.CityCode + '&l=' + window.Config.Language + '&manyKeys=yeka1,yeka2,yeka3,yeka4,yeka5,yekaliu,yeka-big-ad&callback=showManyAd&key=yeka&domid=div_ad&rnd=' + ENetwork.GetExecutionID();
