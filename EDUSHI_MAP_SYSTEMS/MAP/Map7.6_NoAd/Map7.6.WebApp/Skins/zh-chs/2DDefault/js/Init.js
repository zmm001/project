...
function fnMapSearch() {
    ...
    $('BodyContainer').innerHTML = '<div style="margin:3px 0;height:60px;width:234px;"><iframe id="adiframe" src="../adui.html" style="width:234px;height:60px;" frameBorder="0" scrolling="no"></iframe></div>';
    search.setRenderer(sRender);
    sogou.maps.event.addListener(sRender, 'getMarker', function (a, b) {
        infowindow.open(vM, a);
        var div = document.createElement('div');
        div.innerHTML = b.innerHTML + '<div style="margin:3px 0;width:234px;height:65px;"><iframe id="adiframe" src="../adui.html" style="width:234px;height:60px;" frameBorder="0" scrolling="no"></iframe></div>';
