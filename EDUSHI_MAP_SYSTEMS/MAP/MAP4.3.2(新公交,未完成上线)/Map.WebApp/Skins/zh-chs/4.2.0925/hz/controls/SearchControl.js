...
SearchControl.prototype._LocalSearch = function(){
    ...
    {
        if (sKeyword.length > 0 && sKeyword != '请输入关键字，例如 龙井')
        {
    ...
    {
        if (sKeyword.length > 0 && sKeyword != '请输入企业或实体名,例如:阿拉丁')
        {
    ...
    {
        if (sKeyword.length > 0 && sKeyword != '请输入地址，例如：文一路')
        {
...
SearchControl.prototype.onInputChanged = function(input, keyCode, x, y, w, type){
};
SearchControl.prototype.onTabIndexChanged = function(id){
};