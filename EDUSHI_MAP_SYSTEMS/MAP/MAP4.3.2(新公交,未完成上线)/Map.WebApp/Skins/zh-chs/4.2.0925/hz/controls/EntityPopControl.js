...
EntityPopControl.prototype.ClearData = function(){
    ...
    this.$('Entro_yp_img').src = this.Config._ImgPath + 'h.gif';
    this.$('Entro_yp_txt').innerHTML = '详细';
...
{     
    ...
    this.ClearData();
    this.Show();
    var url=this.Config._EDataCenterUrl + 'CommMap/EntityInfo.aspx?node='+this.Config._Node+'&l='+this.Config._L+'&v=1.0&req=2&id='+oid;
...
EntityPopControl.prototype.LoadEntityPopData = function()
{
    ...
    this.$('Entro_yp').href = this.Config._LocalUrl + 'Owner/' + o.ID + '.shtml';  
    this.$('Entro_yp').target = '_blank'; 
    this.$('Entro_yp').onmouseover= function(){ this.src = '../images/ha.gif'; };
    this.$('Entro_yp').onmouseout= function(){ this.src = '../images/h.gif'; };
    this.$('Entro_yp_img').src = this.Config._ImgPath + 'h.gif';
    this.$('Entro_yp_txt').innerHTML = '详细';
    ...
    this.$('Entro_error').onclick = this._cavil.bindAsEventListener(this,2,o.ID,o.OwnerName,o.CenterX,o.CenterY);   
...
EntityPopControl.prototype.ShowComanyPop = function(cid)
{
    ...
    this.ClearData();
    this.Show();
    var url=this.Config._EDataCenterUrl + 'CommMap/EntityInfo.aspx?node='+this.Config._Node+'&l='+this.Config._L+'&v=1.0&req=1&id='+cid;
...
EntityPopControl.prototype.LoadComanyPopData = function()
{
    ...
    if (c.Vip*1 > 0)
    {
        this.$('Entro_yp').onmouseover= null;
        this.$('Entro_yp').onmouseout= null;
        this.$('Entro_yp').href = this.Config._BendiUrl + 'VipStore/' + c.Vip + '/Index.aspx?City=' + this.Config._CityCode + '&StoreID=' + c.ComID;
        this.$('Entro_yp_img').src = this.Config._ImgPath + 'EDian.gif';
        this.$('Entro_yp_txt').innerHTML = '逛店';
    }
    else
    {
        this.$('Entro_yp').onmouseover= function(){ this.src = '../images/ha.gif'; };
        this.$('Entro_yp').onmouseout= function(){ this.src = '../images/h.gif'; };
        this.$('Entro_yp').href = this.Config._LocalUrl + 'Shop/' + c.ComID + '.shtml';
        this.$('Entro_yp_img').src = this.Config._ImgPath + 'h.gif';
        this.$('Entro_yp_txt').innerHTML = '详细';
    }
    this.$('Entro_yp').target = '_blank'; 
