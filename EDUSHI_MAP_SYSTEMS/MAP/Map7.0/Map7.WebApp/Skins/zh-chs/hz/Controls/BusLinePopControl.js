...
Object.extend(BusLinePopControl.prototype, {
    ...
    ShowPop: function(index, Data, type) {
        ...
        if (type == '1') {
            ...
            this.$('BusTime').innerHTML = '首班：' + Data.LineInfo[0].UpStartTime + ' 末班：' + Data.LineInfo[0].UpEndTime;
            ...
            this.$('BusTime').innerHTML = '首班：' + Data.LineInfo[0].DownStartTime + ' 末班：' + Data.LineInfo[0].DownEndTime;
        ...
        this.$('BusLineName').innerHTML = Data.LineInfo[0].VehicleName;
        this.$('BusLineInfo').innerHTML = Data.LineInfo[0].StartStation + '-' + Data.LineInfo[0].EndStation;
        this.$('TicketPrice').innerHTML = '票价：' + Data.LineInfo[0].BusPrice + '元';
