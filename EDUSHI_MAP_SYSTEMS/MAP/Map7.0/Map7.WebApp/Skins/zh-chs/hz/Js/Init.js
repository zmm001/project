...
var MyLocationTab = null, MyMarkTab = null;
function fnLocationList() {
    MyLocationTab = new TabControl.Tab(document, 'LocationList', '我的位置', GlobalConfig.WebRootPath + 'Fundation/MyLocationList.html', true, true, 80);
    fnAddTab(MyLocationTab);
}

function fnMarkList() {
    MyMarkTab = new TabControl.Tab(document, 'MarkList', '备忘标注', GlobalConfig.WebRootPath + 'Fundation/MyMarkList.html', true, true, 80);
    fnAddTab(MyMarkTab);
}
