...
function BusLineSearch() {
    ...
    this.fnShowInfo = function(i) {
        ...
        if (action == 1) {
            ...
            $('TabContent').innerHTML = string.Format("<div style=\"float:left;width: 270px;\"><div class=\"bus_line_top\"></div><div class=\"bus_line_mid\"><h2 style=\"cursor:pointer;\" title=\"{0}-{1}\" id=\"{2}\" onclick=\"javascript:_BusLineSearch.fnLoadData({3},{4});\"><div class=\"mid_sc\"><a><img src=\"../images/bus_ico9.gif\" border=\"0\" /></a></div><div class=\"mid_name\"><span><font style=\"color:#f60; font-weight:bold;\">{5}</font></span>&nbsp;&nbsp;{6}&nbsp;-&nbsp;{7}</div></h2><div id=\"{8}\" style=\"display:none;\"></div></div><div class=\"bus_line_down\"></div></div>", _BusNumberData[i].LineInfo[0].StartStation, _BusNumberData[i].LineInfo[0].EndStation, "LineTitle" + i, i, _BusNumberData[i].LineInfo[0].VehicleID, _BusNumberData[i].LineInfo[0].VehicleName, _BusNumberData[i].LineInfo[0].StartStation, _BusNumberData[i].LineInfo[0].EndStation, "LineInfo" + i);
            $('LineInfo' + i).style.display = 'block';
            fnResize();
        }
