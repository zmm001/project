...
EntityPopControl.prototype.LoadEntityPopData = function()
{
    ...
    this.CompanyListItem = new OptionCardContrlBase.Item(this.Body,'companylist','The building of enterprise',companylisturl,false,false,108);
...
EntityPopControl.prototype.LoadComanyPopData = function()
{
    ...
    if(c.Vip*1>0)
    {
        this.$('Entro_yp').href = 'http://' + c.Domain + '.' + this.Config._AppDomain;
    }
    else
    {
