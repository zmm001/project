var datas = new Vue({
    ...
    methods: {
        ...
        indexRecommendList: function () {
            $.ajax({
                type: "get",
                url: "/Home/GetIndexRecommendList",
                dataType: "json",
                success: function (data) {
                    if (data != null) {
        ...
        indexChannelList: function (flag) {
            $.ajax({
                type: "get",
                url: "/Home/GetChannelList?flag=" + flag,
                dataType: "json",
                success: function (data) {
                    if (data != null) {
                        if (flag == 'male') {
        ...
        indexBookCityRecommend: function () {
            $.ajax({
                type: "get",
                url: "/Home/GetIndexBookCityRecommend",
                dataType: "json",
                success: function (data) {
                    if (data != null) {
        ...
        eachClass: function () {
            $(".module-li").each(function () {
                ...
                $(this).find(".module-li-title span").attr("class", "color0" + _index);
            });
        },
        hrefGO: function (ID) {
