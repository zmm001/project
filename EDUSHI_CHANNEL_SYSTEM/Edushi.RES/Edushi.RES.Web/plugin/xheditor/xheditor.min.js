...
var a=e.val();if(""!==a&&"http://"!==a){var g=a.split(" "),m=f.val(),D=h.val(),s=n.val(),i=j.val(),o=l.val(),p=u.val(),q=r.val();if(1<g.length){var v='<p style="text-align:center;"><img src="xhe_tmpurl"',t=[];""!==m&&(v+=' alt="'+m+'"');""!==D&&(v+=' align="'+D+'"');""!==s&&(v+=' width="'+s+'"');""!==i&&(v+=' height="'+i+'"');""!==o&&(v+=' border="'+o+'"');""!==p&&(v+=' vspace="'+p+'"');""!==q&&(v+=' hspace="'+q+'"');var v=v+" /></p>",w;for(w in g)a=g[w],""!==a&&(a=a.split("||"),m=v,m=m.replace("xhe_tmpurl",a[0]),a[1]&&(m='<a href="'+
a[1]+'" target="_blank">'+m+"</a>"),t.push(m));c.pasteHTML(t.join("&nbsp;"))}else 1===g.length&&(a=g[0],""!==a&&(a=a.split("||"),0===b.length&&(c.pasteHTML('<p style="text-align:center;"><img src="'+a[0]+'#xhe_tmpurl" /></p>'),b=d('img[src$="#xhe_tmpurl"]',k)),L(b,"src",a[0]),""!==m&&b.attr("alt",m),""!==D?b.attr("align",D):b.removeAttr("align"),""!==s?b.attr("width",s):b.removeAttr("width"),""!==i?b.attr("height",i):b.removeAttr("height"),""!==o?b.attr("border",o):b.removeAttr("border"),""!==p?b.attr("vspace",p):b.removeAttr("vspace"),
