...
jQuery(document).ready(function() {
    if (jQuery("#selprovince").length > 0)
        getProvinces();
});
function getProvinces() {
    ...
    jQuery('#selprovince').empty().append(pro);
    getCities();
}
function getCities() {
    var proIndex = jQuery('#selprovince').attr('selectedIndex');
    showCities(proIndex);
    getCounties();
}
