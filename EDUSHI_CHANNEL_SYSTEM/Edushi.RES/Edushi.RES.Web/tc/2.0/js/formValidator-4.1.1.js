    ...
    $.formValidator =
{
    ...
    initConfig: function (controlOptions) {
        ...
        if ($.browser.msie) {
            ...
            css.rel = "stylesheet";
            css.type = "text/css";
            css.href = "http://res.edushi.com/tc/2.0/js/themes/ArrowSolidBox/style/style.css";
            document.getElementsByTagName("head")[0].appendChild(css);
        }
        else {
            var style = document.createElement('style');
            style.setAttribute("type", "text/css");
            var styCss = "@import url('http://res.edushi.com/tc/2.0/js/themes/ArrowSolidBox/style/style.css');";
