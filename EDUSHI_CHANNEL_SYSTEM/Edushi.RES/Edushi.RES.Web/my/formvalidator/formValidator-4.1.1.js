    ...
    $.formValidator =
{
    ...
    initConfig: function (controlOptions) {
        ...
        //    	var themedir = fv_scriptSrc.replace(jsName,'');//themedir + "themes/"+settings.theme+"/js/theme.js"
        //    	$.ajax({ async: false, type: "GET", url: 'http://res.edushi.com/plugin/formvalidator/themes/Default/js/theme.js', dataType: "script",
